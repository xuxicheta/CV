...
Бэкенд на ноде, фронт на Angular. В данный момент на текущем проекте занят в основном тасками связанными с WebRTC и управлением сеансов видеосвязи на бэкенде, провожу ревью кода и консультирую разработчиков.<br>
#### Навыки
* typescript, rxjs <br>
